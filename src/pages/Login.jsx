...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    if (mode === 'signin') {
      ...
      setLoading(false)
      if (error) setError(error.message)
      else setNotice('Cuenta creada. Revisa tu correo si pide confirmación, luego inicia sesión.')
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-secondary px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="flex items-center gap-2.5 mb-6">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: '#185FA5' }}>
            <span className="text-white font-bold text-sm">JR</span>
          </div>
          <div>
            <div className="text-sm font-semibold text-gray-900 leading-tight">GTD Executive OS™</div>
        ...
        <p className="text-sm text-gray-400 mb-5">Tu sistema de productividad ejecutiva.</p>
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center"><span className="bg-white px-2 text-xs text-gray-400">o</span></div>
        </div>
